...
import com.be.dto.JwtResponse;
import com.be.dto.LoginRequestDto;
import com.be.dto.MessageResponse;
import com.be.dto.SignupRequestDto;
...
import com.be.security.service.TokenVerifyService;
import com.be.security.service.UserDetailsImpl;
import com.be.service.IAccountService;
import com.be.service.MailSenderService;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequestDto signUpRequestDto, HttpServletRequest request) {
        ...
        user.setRoles(roles);
        user.setStatus(statusAccNotActived);
